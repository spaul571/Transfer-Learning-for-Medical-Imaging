...
% figures live in ./figures (upload the whole folder to Overleaf)
...
{\scshape\large Daffodil International University\par}
\vspace{0.4cm}
...
{\large\textbf{Quiz 2   Topic E: Transfer Learning for Medical Imaging}\par}
\vspace{0.3cm}
...
\url{https://github.com/spaul571/Quiz-2-Transfer-Learning-for-Medical-Imaging}\par}
...
\url{https://github.com/spaul571/Quiz-2-Transfer-Learning-for-Medical-Imaging}
...
\subsection{Experiment 3   Fine-tuned models and the scratch-versus-fine-tune comparison}
...
\paragraph{Key takeaways.} Per-class recall and AUC-ROC must be reported alongside accuracy, since
...
\paragraph{Future work.} Natural extensions include k-fold cross-validation with multiple seeds and
